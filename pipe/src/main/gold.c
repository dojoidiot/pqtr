...
#include "pipe/mods/demosaic.c"
#include "pipe/mods/exposure.c"
#include "pipe/mods/colorin.c"
#include "pipe/mods/channelmixerrgb.c"
#include "pipe/mods/filmicrgb.c"
#include "pipe/mods/colorbalancergb.c"
#include "pipe/mods/bilat.c"
