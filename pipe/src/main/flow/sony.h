...
// GPU-accelerated pipeline using Dawn/WebGPU.
//
// PIPELINE: prepare() → process_linear() → [gamma]
//
//   prepare()        - Parse ARW2, decode bayer, extract metadata
//   process_linear() - GPU: BLC → Demosaic → WB → ColorMatrix
//
// See prepare.cpp and process.cpp headers for detailed documentation.
