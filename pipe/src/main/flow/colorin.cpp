...
// Extracted from LCMS profile exactly as DT does:
// 1. Invert adobe_XYZ_to_CAM to get cam→XYZ (D65)
// 2. Create ICC profile via cmsCreateRGBProfile with D65 whitepoint
// 3. LCMS applies Bradford D65→D50 internally
// 4. Read colorant tags from profile
// Generated by: src/test/colorin_matrix.cpp
