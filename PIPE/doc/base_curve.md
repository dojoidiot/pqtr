...
| `PIPE/inc/pipe.hpp` | Head::baseCurve(), Link::BaseCurve |
| `PIPE/src/main/part/pipe/pipe.cpp` | HeadImpl stores curve |
| `PIPE/src/main/part/pipe/link.cpp` | BaseCurveImpl |
| `PIPE/src/main/part/pipe/mods/base_curve.cpp` | Apply function |
| `PIPE/src/main/part/pipe/mods/mods.h` | Declarations |
| `PIPE/src/main/part/geos/task.cpp` | Baseline guard (line 179) |
