...
`tool.hpp` provides filesystem I/O utilities that bridge between files and Sinks. It is the **only** place in PIPE where file operations occur, maintaining a clean separation of concerns.
...
## Integration with PIPE Components
...
**tool.hpp** is the **single source of truth** for filesystem I/O in PIPE. It maintains clean architecture by:
