...
ACEO is a covariance-aware optimization strategy for the PIPE dial system. Based on CMA-ES (Covariance Matrix Adaptation Evolution Strategy), ACEO learns the covariance structure of the 45-dial search space and adapts its search to align with the loss landscape.
