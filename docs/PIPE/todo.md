...
- `PIPE/inc/pipe.hpp` - Head::baseCurve(), Link::BaseCurve simplified
- `PIPE/src/main/part/pipe/pipe.cpp` - HeadImpl stores/exposes curve
- `PIPE/src/main/part/pipe/link.cpp` - BaseCurveImpl applies curve
- `PIPE/src/main/part/pipe/mods/base_curve.cpp` - gamma-space LUT apply
- `PIPE/src/main/part/geos/task.cpp` - baseline guard
...
2. **Luminance-preserving tone mapping** (PIPE change)
