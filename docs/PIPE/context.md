...
- `PIPE/src/main/part/pipe/mods/poly_color.cpp` - applies polynomial transform
- `PIPE/src/main/part/geos/data.cpp` - serializes poly_coeffs to/from JSON
- `PIPE/src/main/tune.cpp` - three-phase optimizer
- `PIPE/src/main/labs.cpp` - pipeline runner

## Test Command

```bash
cd /home/z/base/code/pqtr/PIPE
